...
fn setup(
    ...
    // entities
    spawn_entity_from_path(&mut commands, "./assets/test.entity", &asset_server, None, None, None);
    spawn_entity_from_path(&mut commands, "./assets/camera.entity", &asset_server, None, None, None);
}
